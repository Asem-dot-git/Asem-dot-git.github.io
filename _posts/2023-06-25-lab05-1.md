...
![error](/assets/images/malware-analysis/imports.png)
...
![error](/assets/images/malware-analysis/call_func.png)

we found some functions call it but as we see It is called nine times...
![error](/assets/images/malware-analysis/xrefs.png)
...
![error](/assets/images/malware-analysis/off_dns.png)

![error](/assets/images/malware-analysis/dns_request.png)
...
![error](/assets/images/malware-analysis/var.png)
...
![error](/assets/images/malware-analysis/search_text.png)

![error](/assets/images/malware-analysis/text.png)


## 8.What is happening in the area of code that references \cmd.exe /c?

By following the xref to the subroutine which references \cmd.exe /c:
![error](/assets/images/malware-analysis/cmd.png)

there are many interesting values being pushed to the stack:
![error](/assets/images/malware-analysis/quit.png)

![error](/assets/images/malware-analysis/exit.png)

![error](/assets/images/malware-analysis/cd.png)

![error](/assets/images/malware-analysis/inject.png)

![error](/assets/images/malware-analysis/minstall.png)

we can find that the char array aHiMasterDDDDDD mentioning a ‘Remote Shell Session’

![error](/assets/images/malware-analysis/shell.png)
...
![error](/assets/images/malware-analysis/crf_ref.png)
...
![error](/assets/images/malware-analysis/get_version.png)
![error](/assets/images/malware-analysis/cmp.png)
...
![error](/assets/images/malware-analysis/graph.png)
...
![error](/assets/images/malware-analysis/grph.png)
...
![error](/assets/images/malware-analysis/sleep.png)

## 15. At 0x10001701 is a call to socket. What are the three parameters?

socket function has three parameters `af`, `type`, `protocol`(2,1,6)
![error](/assets/images/malware-analysis/socket.png)
...
![error](/assets/images/malware-analysis/msdn1.png)
![error](/assets/images/malware-analysis/msdn2.png)
...
![error](/assets/images/malware-analysis/in.png)
![error](/assets/images/malware-analysis/vm.png)
...
![error](/assets/images/malware-analysis/VPCEXT.png)


## 18. Jump your cursor to 0x1001D988. What do you find?

Probably an encoded string:
![error](/assets/images/malware-analysis/encoded_str.png)
